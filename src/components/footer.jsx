    ...
    <div className=" py-10">
      ...
      <div className=" py-10 flex flex-wrap md:flex-nowrap justify-center md:justify-between gap-10">
        ...
        <div className="md:flex-1 w-full mx-auto text-center md:text-left">
          ...
          {footer.contact.others.map((el, index) => (
        ...
        <div className="md:flex-1 w-full mx-auto text-center md:text-left">
          ...
          {footer.quickMenu.others.map((el, index) => (
            <p
              key={index}
              className=" text-zinc-400 text-sm underline cursor-pointer mb-1 hover:text-teal-200 duration-200"
            >
              {el}
            </p>
          ))}
        ...
        <div className="md:flex-1 w-full mx-auto text-center md:text-left">
          ...
          {footer.socials.others.map((el, index) => (
            <p
              key={index}
              className=" text-zinc-400 text-sm underline cursor-pointer mb-1 hover:text-teal-200 duration-200"
            >
      ...
      <div className=" text-sm text-center md:text-left text-zinc-400">
        © 2023 by Gigaplay. Created on{" "}
        <span className="underline cursor-pointer">Editor X.</span>
      </div>
    </div>
  );
};
